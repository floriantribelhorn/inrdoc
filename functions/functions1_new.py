...
def main(logstate):
    ...
    if logstate == True:
        ...
        st.sidebar.page_link("seiten/sign_up.py", label="Login", icon = "🔒")
        st.sidebar.page_link("seiten/overview.py", label="Überblick", icon = "🈺")
        st.sidebar.page_link("seiten/messeingabe.py", label="Messungen", icon = "💻")
        st.sidebar.page_link("seiten/editor.py", label="Editor", icon = "🈺")
        st.sidebar.page_link("seiten/logout.py", label = "Ausloggen", icon = "🔒")
    else:
        st.sidebar.page_link("seiten/sign_up.py", label="Login", icon = "🔒")
